...
//switch 의 괄호에는 조건이 아닌 값이 이 들어감
switch(a){
    //csse 에는 값에 대한 경우가 들어감
case 3: 
    console.log("a 가 3입니다")
    break
case 4:
    console.log("a 가 4입니다")
    break// break 없으면 해당 호줄에서 빠져나오지 못해 밑에 있는 것까지 실행된다
case 5: // 이렇게 2가지 케이스 같이 써도 됨
case 6: 
    console.log("a 가 5입니다")
    break
default:
